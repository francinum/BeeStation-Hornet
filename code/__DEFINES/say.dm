...
//Radio rework swapspace
#define MODE_SAYMODE 			"saymode" 		//Defer to saymode explicitly.
#define MODE_HEADSET_SPECIAL	"specialset"	//Push the prefix to the headset for processing
#define MODE_STATIC_SPECIAL		"specialcom"	//Push the prefix to the Static Radio for processing